...
#aqui los tokens se comprueba que tipo de token es y si esta bien estructurado
#una vez definido que es, se busca donde embona y se manda al yacc
#donde verifica de nuevo que este bien y empieza el analizador sintactico
def p_program(p):
